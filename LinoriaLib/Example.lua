...
local Library = loadstring(game:HttpGet(repo .. "Library.lua?t=" .. t))()
...
local WatermarkConnection = game:GetService("RunService").RenderStepped:Connect(function()
	...
	if CanDoPing then
		Library:SetWatermark(("LanternX | %d fps | %d ms"):format(
			math.floor(FPS),
			GetPing()
		));
	else
		Library:SetWatermark(("LanternX | %d fps"):format(
			math.floor(FPS)
		));
	end
end);
...
SaveManager:SetFolder("LanternX/specific-game")
